...
def _migrate(engine):
    ...
    migrations = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS courier_transport VARCHAR NOT NULL DEFAULT 'walking'",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS courier_vehicle_plate VARCHAR",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS courier_vehicle_brand VARCHAR",
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS courier_vehicle_color VARCHAR",
